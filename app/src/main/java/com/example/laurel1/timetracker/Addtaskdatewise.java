...
public class Addtaskdatewise extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final Spinner sp_clientname=(Spinner)view.findViewById(R.id.client_nm_sd);
        final Spinner sp_projectname=(Spinner)view.findViewById(R.id.project_nm_sd);
        final EditText task=(EditText)view.findViewById(R.id.task_sd);
        final EditText hours=(EditText)view.findViewById(R.id.hours_sd);
       /* DateFormat df = new SimpleDateFormat("d/MM/yyyy");
        final String date = df.format(Calendar.getInstance().getTime());*/
                     // new Showtask().execute(date);
        Submit=(Button)view.findViewById(R.id.btnsub_sd);
       /*Client c = new Client();
        c.getClass();*/
        new Client().execute();
        new Project().execute();
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                date=FragmentThree.selectdate;
                if(date.equals("")){
                    Toast.makeText(getActivity(),"Date Not Found", Toast.LENGTH_SHORT).show();
                }
                else {
                    new Submittask().execute(Client,Project,Task,Hours,date);
                }
                FragmentTransaction trans = getFragmentManager().beginTransaction();
                trans.replace(R.id.frameaddnewselectdate, new FragmentThree());
    ...
    public Addtaskdatewise() {
        // Required empty public constructor
    }
    // TODO: Rename and change types and number of parameters
    public static Addtaskdatewise newInstance(String param1, String param2) {
        Addtaskdatewise fragment = new Addtaskdatewise();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_addtaskdatewise, container, false);
    }
    ...
    public class Submittask extends AsyncTask<String,String,String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            String result = "";
            HttpEntity entity;
            String url = "http://kritii.co/TimeTracker/save_today_task.php";
