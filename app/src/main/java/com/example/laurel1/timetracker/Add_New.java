...
public class Add_New extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final Spinner sp_clientname=(Spinner)view.findViewById(R.id.client_nm_new);
        final Spinner sp_projectname=(Spinner)view.findViewById(R.id.project_nm_new);
        final EditText task=(EditText)view.findViewById(R.id.task_new);
        final EditText hours=(EditText)view.findViewById(R.id.hours_new);
        DateFormat df = new SimpleDateFormat("d/MM/yyyy");
        date = df.format(Calendar.getInstance().getTime());
       /* DateFormat df = new SimpleDateFormat("dd/mm/yyyy");
        date = df.format(Calendar.getInstance().getTime());*/
        // new Showtask().execute(date);
        Submit=(Button)view.findViewById(R.id.btnsub_new);
        /* Client c = new Client();
        c.getClass();*/
        new Client().execute();
        new Project().execute();
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                  ...
                  if (hours.getText().toString().equals(""))
                  {
                    ...
                    trans.replace(R.id.frameaddnew, new Todaylist());
               ...
               /* else {
                    AlertDialog alertDialog = new AlertDialog.Builder(getActivity()).create();
                    alertDialog.setTitle("oops!");
                    alertDialog.setMessage("Select Valid Data");
                    alertDialog.setButton("Ok",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    //dismiss the dialog
